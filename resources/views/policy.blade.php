        ...
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            ...
            <div class="w-full-1 sm:max-w-2xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Finance</p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Finance.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Finance, accessible from <a href="/" rel="external nofollow noopener" target="_blank">finance.com</a></p>
                    </li>
                    <li>
